...
Notes: - Before every release, I test this application on around 100 documents (including documents provided to me that processed incorrectly previously) and run through 2,200+ tests. - You may need to click the "Reset" button within Processing Options for some of the new processing options to have their recommended enabled / disabled configuration shown.
